...
print_summary() {
    ...
    printf "  agentpack search react              ${MUTED}# find skills on agentskills.io${NC}\n"
    printf "  agentpack add owner/repo            ${MUTED}# add a skill from git${NC}\n"
    printf "  agentpack add repo --skill review   ${MUTED}# add a specific skill${NC}\n"
    printf "  agentpack ls                        ${MUTED}# list installed plugins${NC}\n"
    printf "  agentpack ls --targets              ${MUTED}# show detected agents${NC}\n"
    printf "  agentpack init my-skill             ${MUTED}# scaffold a new skill project${NC}\n"
    printf "\n"
