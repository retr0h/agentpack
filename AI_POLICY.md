...
The claudia project has strict rules for AI usage:
...
These rules apply only to outside contributions to claudia. Maintainers
...
Please remember that claudia is maintained by humans.
...
claudia is written with plenty of AI assistance, and many maintainers
