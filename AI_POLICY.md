...
The agentpack project has strict rules for AI usage:
...
These rules apply only to outside contributions to agentpack. Maintainers are
...
Please remember that agentpack is maintained by humans.
...
agentpack is written with plenty of AI assistance, and many maintainers embrace
